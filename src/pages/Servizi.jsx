...
import pezzo1  from '../assets/pages/servizi/pezzi/pezzo-1.webp';
import pezzo2  from '../assets/pages/servizi/pezzi/pezzo-2.webp';
import pezzo3  from '../assets/pages/servizi/pezzi/pezzo-3.webp';
import pezzo4  from '../assets/pages/servizi/pezzi/pezzo-4.webp';
import pezzo5  from '../assets/pages/servizi/pezzi/pezzo-5.webp';
import pezzo6  from '../assets/pages/servizi/pezzi/pezzo-6.webp';
import pezzo7  from '../assets/pages/servizi/pezzi/pezzo-7.webp';
import pezzo8  from '../assets/pages/servizi/pezzi/pezzo-8.webp';
import pezzo9  from '../assets/pages/servizi/pezzi/pezzo-9.webp';
import pezzo10 from '../assets/pages/servizi/pezzi/pezzo-10.webp';
import pezzo11 from '../assets/pages/servizi/pezzi/pezzo-11.webp';
...
const PEZZI = [pezzo1,pezzo2,pezzo3,pezzo4,pezzo5,pezzo6,pezzo7,pezzo8,pezzo9,pezzo10,pezzo11];

const TIPI_PEZZO = [
    'Prototipi','Collari','Alberi','Porta satelliti',
    'Scatole differenziali','Ruote','Corpi riduttori',
    'Pistoni','Supporti','Flange',
];
                ...
                <Reveal delay="d2">
                    <div className="flex items-start gap-6 md:gap-10">
                        ...
                        <div className="hidden w-44 shrink-0 md:block lg:w-52">
                            ...
                            <Link
                                to="/contattaci"
                                className="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-5 py-3 text-xs font-bold tracking-wider text-white uppercase transition-all hover:bg-blue-500 hover:-translate-y-0.5"
                            >
                                Contattaci qui
...
export default function Servizi() {
    return (
        <>
            <SEO
                title="Servizi | Fresatura CNC e Tornitura CNC"
            ...
            <div className="font-body bg-white text-slate-800">
                ...
                <section className="mt-20 px-6 pt-20 pb-24 md:pt-28 md:pb-32">
                    <div className="mx-auto max-w-6xl">
                        <Reveal delay="d1">
                            <p className="mb-3 text-xs font-bold tracking-widest text-blue-600 uppercase">— Parco macchine</p>
                            <h1 className="font-display mb-4 text-4xl font-bold leading-tight md:text-5xl lg:text-6xl">
                                Tecnologia CNC<br />
                            ...
                            {MACCHINE.map((m, i) => (
                                <Reveal key={m.nome} delay={`d${(i % 2) + 1}`}>
                                    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                                        {/* Foto placeholder — sostituire con <img src={...} /> quando disponibili */}
                                        ...
                                        <div className="p-6">
                                            ...
                                            <h2 className="font-display mb-0.5 text-2xl font-bold text-slate-900">{m.nome}</h2>
